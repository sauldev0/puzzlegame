...
func _on_npc_marta_area_entered(area):
	posicion_guardada = position  # Guardamos antes de empezar a seguir
	seguir_jugador = true
	zoom_objetivo = mas_zoom


func _on_npc_marta_area_exited(area):
	seguir_jugador = false
	zoom_objetivo = zoom_original
	posicion_objetivo = posicion_guardada  # Volver a la posición previa al seguimiento


func _on_npc_sofia_area_entered(area):
	posicion_guardada = position  # Guardamos antes de empezar a seguir
	seguir_jugador = true
	zoom_objetivo = mas_zoom


func _on_npc_sofia_area_exited(area):
	seguir_jugador = false
	zoom_objetivo = zoom_original
	posicion_objetivo = posicion_guardada  # Volver a la posición previa al seguimiento


func _on_npc_diego_area_entered(area):
	posicion_guardada = position  # Guardamos antes de empezar a seguir
	seguir_jugador = true
	zoom_objetivo = mas_zoom


func _on_npc_diego_area_exited(area):
	seguir_jugador = false
	zoom_objetivo = zoom_original
	posicion_objetivo = posicion_guardada  # Volver a la posición previa al seguimiento


func _on_npc_carla_area_entered(area):
	posicion_guardada = position  # Guardamos antes de empezar a seguir
	seguir_jugador = true
	zoom_objetivo = mas_zoom


func _on_npc_carla_area_exited(area):
	seguir_jugador = false
	zoom_objetivo = zoom_original
	posicion_objetivo = posicion_guardada  # Volver a la posición previa al seguimiento
